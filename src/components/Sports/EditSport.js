...
class EditSport extends Component {
  ...
  handleSubmit = async  (e) => {
    ...
    let response = await fetch(`${Api()}/sports/${id}`,{
      method:"PUT",
          ...
          <div className="col  col-sm-8 col-md-8 col-lg-8 col-xl-8 offset-3">
            ...
            <form className="form-horizontal" onSubmit={this.handleSubmit} >
              <div className="form-group">
                <label htmlFor="title" className="text-info" >Sport id</label>
              ...
              <div className="form-group files ">
                <label htmlFor="upload" className="text-info">Upload your file</label>
              ...
              <a href={`/sports/${this.state.id}`} className="btn btn-outline-info btn-lg float-right ">Back to the posts</a>
