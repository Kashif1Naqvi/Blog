...
class EditNational extends Component {
  constructor(props){
    super(props)
    this.state = {
        ...
        <div className="row" >
          <div className="col col-sm-8 col-md-8 col-lg-8 col-xl-8 offset-3">
            ...
            <form className="form-horizontal" onSubmit={this.handleSubmit} >
              ...
              <a href={`/national/${this.state.id}`} className="btn btn-outline-info btn-lg float-right " >Back to the posts</a>
