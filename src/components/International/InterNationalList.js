        ...
        <div className="card-group mt-4 ">
          <div className="card">
            ...
            <div className="card-footer">
                <Link to={`${this.props.history.location.pathname}/${this.props.id}`}  className="btn btn-outline-primary float-right ">See more</Link>
            </div>
          </div>
        </div>
      </div>
...
export default withRouter(InterNationalList)